...
var poll = [
    ...
    {
        num: 2,
        question: "Какой предмет вы выбрали бы для сдачи, даже если бы они не были обязательны, исходя из интереса?",
        answers:["Обществознание", "Физика", "Литература", "Информатика",  "Русский язык", "Английский язык", "История", "Биология", "Химия", "География", "Математика"]
    },
    {
        num: 3,
    ...
    {
        num: 4,
        question: "На каком уроке выполнять практические работы вам интереснее всего?",
        answers:["Обществознание", "Физика", "Литература", "Информатика",  "Русский язык", "Английский язык", "История", "Биология", "Химия", "География", "Математика"]
    },
    {
        num: 5,
